  ...
  <div ref="turntableRef" class="turntable" v-show="show">
    ...
    <div class="turntable-outer">
      <div ref="turntableInnerRef" class="turntable-outer__wrapper">
        ...
        <div class="sector"><img id="bmhSprout" src="@/assets/flower_icons/xcj_sprout.png" /></div>
        <div class="sector"><img id="bmhBloom" src="@/assets/flower_icons/xcj_bloom.png" /></div>
        <div class="sector"><img id="bmhFruit" src="@/assets/flower_icons/xcj_fruit.png" /></div>
        <div class="sector"><img id="xcjSeed" src="@/assets/flower_icons/bmh_seed.png" /></div>
        <div class="sector"><img id="xcjSprout" src="@/assets/flower_icons/bmh_sprout.png" /></div>
        <div class="sector"><img id="xcjBloom" src="@/assets/flower_icons/bmh_bloom.jpg" /></div>
        <div class="sector"><img id="xcjFruit" src="@/assets/flower_icons/bmh_fruit.png" /></div>
        <div class="sector"><img id="xhhSeed" src="@/assets/flower_icons/xhh_seed.png" /></div>
        <div class="sector"><img id="xhhSprout" src="@/assets/flower_icons/xhh_sprout.png" /></div>
        <div class="sector"><img id="xhhBloom" src="@/assets/flower_icons/xhh_bloom.png" /></div>
        <div class="sector"><img id="xhhFruit" src="@/assets/flower_icons/xhh_fruit.png" /></div>
      </div>
      <div class="arrow"></div>
    </div>
  </div>
...
const getElTransformAngle = (el: Element): number => {
  ...
  if (transform && transform !== 'none') {
    ...
    if (matrix.length === 6) {
      angle = Math.round(Math.atan2(parseFloat(matrix[1]), parseFloat(matrix[0])) * (180 / Math.PI)); // 计算旋转角度
    }
  }
...
.turntable {
  ...
  &-outer {
    ...
    &__wrapper {
      ...
      background-image: sectorar-gradient(43deg, #4158d0 0%, #c850c0 46%, #ffcc70 100%);

      .sector {
        $w: ($R + $r + $padding) * 2 * math.tan(math.div($pDeg, 2) * math.div(math.$pi, 180));
