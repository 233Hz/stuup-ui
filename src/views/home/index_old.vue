...
import video from '@/assets/video/video-background.webm';
...
.contaienr {
  ...
  .test1 {
    ...
    width: 1315px;
    height: 980px;
    background: url(../../assets/image/bird.png) no-repeat;
    background-size: 1315px 7840px;
    animation: fly 1s steps(8, end) infinite, move 20s infinite;
  ...
  //   width: 10rem;
  //   height: 10rem;
  //   background: url(./bird.png) no-repeat 0 0;
  //   animation: 3s move infinite alternate-reverse;
  // }
}
