...
<script setup lang="ts" name="RecDeductScore">
import { onMounted, ref } from 'vue'
import { reqRecDeductScorePage } from '@/api/growScore/recDeductScore'
...
const fetchData = async () => {
  ...
  try {
    ...
    const { data: res } = await reqRecDeductScorePage(query)
