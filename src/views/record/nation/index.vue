    ...
    <el-col :span="24">
      <el-card shadow="never">
        ...
        <el-table :data="tableData" border stripe v-loading="loading" empty-text="空空如也~~" style="width: 100%">
          ...
          <el-table-column prop="unit" label="主管单位" show-overflow-tooltip align="center" />
          <el-table-column prop="school" label="学校" show-overflow-tooltip align="center" />
...
const fetchList = async () => {
  loading.value = true;
  try {
    const { data: res } = await getRecNationPage(Object.assign(page.value, searchForm.value));
