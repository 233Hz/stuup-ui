  ...
  <div style="padding: 10px 20px">
              ...
              <el-row>
                <el-col :sm="24" :md="12" :xl="8">
                  <el-form-item label="所属学年" prop="yearId">
                    <el-select v-model="searchForm.yearId" placeholder="请选择" class="w-full">
    ...
    <el-card>
      ...
      <el-table :data="tableData" border stripe v-loading="loading" empty-text="空空如也~~" style="width: 100%">
        <el-table-column prop="yearName" label="所属学年" show-overflow-tooltip align="center" />
    ...
    <el-dialog v-model="active" :title="title" width="500" draggable @close="resetForm">
      <el-form
        ref="formRef"
        :model="form"
        :rules="rules"
...
import { pageSemester, saveOrUpdateSemester, delSemester, setCurrentSemester } from '@/api/basic/semester';
...
const submitForm = async () => {
  ...
  try {
    const res = await saveOrUpdateSemester(Object.assign(data, { startTime, endTime }));
    ElMessage.success(res.message);
    active.value = false;
    fetchList();
  } finally {
