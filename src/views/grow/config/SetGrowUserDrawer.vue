<template>
  <el-drawer v-model="active" title="设置项目负责人" direction="rtl" @close="reset">
    <el-row>
      <el-col :span="24">
          ...
          <el-row>
            ...
            <el-col :sm="24" :md="12" :xl="12">
              <el-form-item label="教师工号" prop="teacherNo">
                <el-input v-model="searchForm.teacherNo" placeholder="请输入教师工号" />
              </el-form-item>
            </el-col>
            <el-col :sm="24" :md="12" :xl="12">
              <el-form-item label="所属部门" prop="deptId">
                <el-select v-model="searchForm.deptId" placeholder="请选择所属部门">
                  <el-option v-for="item in DEPT" :key="item.oid" :label="item.value" :value="item.oid" />
                </el-select>
              </el-form-item>
            </el-col>
          </el-row>
    ...
    <template #footer>
      <el-space>
        ...
        <el-button type="primary" :loading="loading" @click="setGrowUser">提交</el-button>
      </el-space>
    </template>
  </el-drawer>
</template>
